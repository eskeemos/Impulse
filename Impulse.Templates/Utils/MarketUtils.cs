...
using System;
namespace Impulse.Shared.Utils
{
    public static class MarketUtils
    {
        ...
        public static decimal ClampPrice(BinanceSymbol symbolInfo, decimal priceIn, decimal weightedAverage)
        {
            ...
            {
                price = Math.Min(symbolInfo.PricePercentFilter.MultiplierDown * weightedAverage, price);
            }
            ...
            {
                price = Math.Min(symbolInfo.PriceFilter.MinPrice, price);
            }
